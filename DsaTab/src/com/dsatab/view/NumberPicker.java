...
public class NumberPicker extends LinearLayout implements OnClickListener, OnFocusChangeListener, OnLongClickListener,
	...
	public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
		...
		mText.setImeActionLabel("Reset", EditorInfo.IME_ACTION_SEARCH);
	...
	public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
		...
		if (actionId == EditorInfo.IME_ACTION_SEARCH && getTag() instanceof Value) {
			Value value = (Value) getTag();
			setCurrent(value.getReferenceValue());
			return true;
		} else if (event != null && event.getKeyCode() == KeyEvent.KEYCODE_DEL) {
